...
exec(open("Q:/My Drive/Code Archive/R Code/HIP-R-Leif - Edits 1/inst/python/all_functions.py").read())
#exec(open("Q:/My Drive/Code Archive/R Code/HIP-R-Leif - Edits 1/inst/python/helper_functions.py").read())
#exec(open("Q:/My Drive/Code Archive/R Code/HIP-R-Leif - Edits 1/inst/python/adagrad_functions.py").read())
...
res = select_lambda(Y = dat_train['Y'], X = dat_train['X'], topn = nonzero,
              gamma = [1.0 for d in range(D)], family = family, K = K, ncore = 1,
...
### Can create a function called predict with these families, calling appropriate train/test
if family == 'gaussian':
